from sklearn.feature_extraction.text import CountVectorizer, TfidfTransformer  # Import necessary libraries
...
# Iterate through each vector in the training set and test set, and calculate cosine similarity
for vector in trainVectorizerArray:
    ...
    for testV in testVectorizerArray:
        ...
        print(f"Cosine similarity: {cosine}")  # Display the cosine similarity

# Fit the transformer to the training set and transform it to TF-IDF representation
transformer.fit(trainVectorizerArray)
print("\nTF-IDF for training set:", transformer.transform(trainVectorizerArray).toarray())

# Fit the transformer to the test set and transform it to TF-IDF representation
transformer.fit(testVectorizerArray)
print("\nTF-IDF for test set:", transformer.transform(testVectorizerArray).todense())
